 ...
 * BUILD & RUN:
 *   npm run build
 *   npx transcript-test . tests/transcripts/v10-switchable.transcript
...
class FamilyZooStory implements Story {
  ...
  initializeWorld(world: WorldModel): void {
    ...
    const ironFence = world.createEntity('iron fence', EntityType.OBJECT);
    ...
    const flowerBeds = world.createEntity('flower beds', EntityType.OBJECT);
    ...
    const hayBale = world.createEntity('hay bale', EntityType.OBJECT);
    ...
    const perches = world.createEntity('rope perches', EntityType.OBJECT);
    ...
    const shelves = world.createEntity('metal shelves', EntityType.OBJECT);
    ...
    const sugarGliders = world.createEntity('sugar gliders', EntityType.OBJECT);
    ...
    const bushBabies = world.createEntity('bush babies', EntityType.OBJECT);
    ...
    const barnOwl = world.createEntity('barn owl', EntityType.OBJECT);
