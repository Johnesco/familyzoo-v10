# Family Zoo — v10 — Switchable Devices — Claude Project Memory
...
**Name:** Family Zoo — v10 — Switchable Devices
**Purpose:** Sharpee tutorial step 10 — Switchable Devices.
...
**Repository:** https://github.com/Johnesco/familyzoo-v10
**Live:** https://johnesco.github.io/familyzoo-v10/
...
├── familyzoo-10.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v10.story`.
